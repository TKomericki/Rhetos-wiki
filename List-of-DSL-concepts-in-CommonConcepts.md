The CommonConcepts package is a **standard library** of common business features, implemented as a domain-specific programming language (DSL). It is a recommended package to include in all Rhetos apps.
