...
3. [Apply the required changes to your existing code](#apply-the-required-changes-to-your-existing-code)
   1. [NuGet packages must contain DLLs in "lib" instead of "Plugins"](#nuget-packages-must-contain-dlls-in-%22lib%22-instead-of-%22plugins%22)
   ...
   4. [The "Resources" folder is not generated by default](#the-%22resources%22-folder-is-not-generated-by-default)
...
1. For existing applications and plugins to work, **enable** "Resources" folder
   ...
   `"BuildResourcesFolder": true`, is not enabled already.
